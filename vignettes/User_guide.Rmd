...
- `environment_sampling_interval`: time between generated environmental temperature values in model-time units. The default is `1`.
...
- \(T_t\): environmental temperature at time \(t\), obtained from the generated
  ...
  `simulation.environment_sampling_interval` spacing and then interpolated using
...
- `temperatures.db`: SQLite database containing the full generated
  ...
  environmental sample generated at `simulation.environment_sampling_interval`,
