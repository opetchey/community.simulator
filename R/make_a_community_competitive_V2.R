...
#'
#' @examples NULL
make_a_community_competitive_V2 <- function(S,
  ...
  #temp <- rexp(S * S, rate = 1 / alpha_ij_mean)
  #temp <- rlnorm(S * S, meanlog = log(alpha_ij_mean), sdlog = 1)
  temp <-runif(S * S, min = 0, max = 2 * alpha_ij_mean)
