## plots for an individual community
...
# 
# ## bring in experiment data. this includes community parameters and treatments
# expt <- readRDS(here("data", pack, "expt_communities.RDS"))
# 
# 
# ## open connections to required databases
# ## temperatures
